...
const MOUSE_Y_SNAPEBACK_THRESHOLD := 621 ## 138
...
func enter() -> void:
	...
	Events.card_aim_started.emit(card_ui) # event bus
...
func on_input(event:InputEvent) -> void:
	...
	var mouse_at_bottom := card_ui.get_global_mouse_position().y > MOUSE_Y_SNAPEBACK_THRESHOLD
